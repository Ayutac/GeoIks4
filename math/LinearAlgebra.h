...
class StaticMatrix {
 ...
 public:
   ...
   */
   ...
   void computeEigenStructure( StaticVector<FloatType,rows>& eigenValues, StaticMatrix<FloatType,rows,columns>& eigenVectors ) const;
...
inline Matrix3f expand2To3(Matrix2f v);
...
/// transformation in homogeneous coordinates (adds w=1 automatically, shrinks back afterwards)
inline Vector3f transformVector3f(const Matrix4f &M, const Vector3f &v);
/// transformation in homogeneous coordinates (adds w=1 automatically, shrinks back afterwards)
inline Vector3f transformVector3f(const Matrix4f &M, const Vector3f &v);
/// transformation w/division in homogeneous coordinates (adds w=1 automatically and performs division)

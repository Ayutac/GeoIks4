...
ExaminerCameraController::ExaminerCameraController() {
   ...
   distance = 10.0;
   angles = makeVector2f((float32)M_PI, 0);
...
void ExaminerCameraController::mouseWheelRotated( int32 rotatedDelta, Modifiers modifiersState )
{
   UNUSED(modifiersState);

...
ObjectBrowserWidget::ObjectBrowserWidget(Object *obj, ClassEditor *clEd, QWidget *parent, Qt::WindowFlags f, bool deleteEditorOnClose) : QDialog(parent, f) {
   this->obj = obj;
   this->clEd = clEd;
   this->deleteEditorOnClose = deleteEditorOnClose;
   ui.setupUi(this);

...
ClassSelectionDialog::ClassSelectionDialog(QWidget * parent, Qt::WindowFlags f)
:QDialog(parent, f )
{
	...
	// load icons
   m_ClassIcon = new QIcon( ":/images/small_class.png" );
   m_AbstractClassIcon = new QIcon( ":/images/small_class_abstract.png" );

...
#define ADD_CARD8_PROP_UPDATE( propName, version, updateMethodPtr ) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (Card8UpdateMethod) updateMethodPtr ) );
...
#define ADD_CARD16_PROP_UPDATE( propName, version, updateMethodPtr) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (Card16UpdateMethod) updateMethodPtr ) );
...
#define ADD_CARD32_PROP_UPDATE( propName, version, updateMethodPtr ) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (Card32UpdateMethod) updateMethodPtr ) );
...
#define ADD_CARD64_PROP_UPDATE( propName, version, updateMethodPtr ) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (Card64UpdateMethod) updateMethodPtr ) );
...
#define ADD_INT8_PROP_UPDATE( propName, version, updateMethodPtr ) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (Int8UpdateMethod) updateMethodPtr ) );
...
#define ADD_INT16_PROP_UPDATE( propName, version, updateMethod ) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (Int16UpdateMethod) updateMethodPtr ) );
...
#define ADD_INT32_PROP_UPDATE( propName, version, updateMethodPtr ) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (Int32UpdateMethod) updateMethodPtr ) );

#define ADD_INT64_PROP_UPDATE( propName, version, updateMethodPtr ) \
	((MetaClass*)getClass())->addProperty( new Int64ClassProperty( #propName , MetaClass::FIRST_VERSION + version, \
    (pointer_diff)(&( obj_null_pointer->propName )), (Int64UpdateMethod) updateMethodPtr ) );
...
#define ADD_FLOAT32_PROP_UPDATE( propName, version, updateMethodPtr ) \
    ...
    (pointer_diff)(&( obj_null_pointer-> propName )), (Float32UpdateMethod) updateMethodPtr ) );
...
#define ADD_FLOAT64_PROP_UPDATE( propName, version, updateMethodPtr ) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (Float64UpdateMethod)updateMethodPtr ) );
...
#define ADD_MAX_PLATFORM_CARD_PROP_UPDATE( propName, version, updateMethodPtr ) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (MaxPlatformCardUpdateMethod) updateMethodPtr ) );
...
#define ADD_MAX_PLATFORM_INT_PROP_UPDATE( propName, version, updateMethodPtr ) \
    ...
    (pointer_diff)(&( obj_null_pointer->propName )), (MaxPlatformIntUpdateMethod)updateMethodPtr ) );
...
#define ADD_CARD32_PROP_UPDATE_DESCR( propName, version, updateMethodPtr, descr, numDescr ) \
	((MetaClass*)getClass())->addProperty( new Card32ClassProperty( #propName , MetaClass::FIRST_VERSION + version, \
   (pointer_diff)(&( obj_null_pointer->propName )), (Card32UpdateMethod) updateMethodPtr, (GetCard32EnumDescriptionMethod) descr, numDescr) );

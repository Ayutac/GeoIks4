...
EmbeddedObjectElementEditor::EmbeddedObjectElementEditor(QWidget * parent,Qt::WindowFlags f)
...
EmbeddedObjectInlineElementEditor::EmbeddedObjectInlineElementEditor(QWidget * parent,Qt::WindowFlags f)
:ElementEditor(parent,f)
{
	m_Object = NULL;
	m_Property = NULL;

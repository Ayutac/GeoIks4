...
#define ADD_FLOAT32_FIXED_ARRAY_PROP( propName, version, count, entriesPerRow ) \
   ...
   (pointer_diff)(&( obj_null_pointer->propName ) - ((pointer_diff)NULL)) , new Float32ClassProperty("", version , ((pointer_diff)NULL)) \
	,count, sizeof(float32), entriesPerRow ));

#define ADD_INT32_FIXED_ARRAY_PROP( propName, version, count, entriesPerRow ) \
	((MetaClass*)getClass())->addProperty( new FixedArrayClassProperty( #propName , MetaClass::FIRST_VERSION + version, \
   (pointer_diff)(&( obj_null_pointer->propName ) - ((pointer_diff)NULL)) , new Int32ClassProperty("", version , ((pointer_diff)NULL)) \
	,count, sizeof(int32), entriesPerRow ));

#define ADD_CARD32_FIXED_ARRAY_PROP( propName, version, count, entriesPerRow ) \
	((MetaClass*)getClass())->addProperty( new FixedArrayClassProperty( #propName , MetaClass::FIRST_VERSION + version, \
   (pointer_diff)(&( obj_null_pointer->propName ) - ((pointer_diff)NULL)) , new Card32ClassProperty("", version , ((pointer_diff)NULL)) \
	,count, sizeof(card32), entriesPerRow ));

#define ADD_CARD8_FIXED_ARRAY_PROP( propName, version, count, entriesPerRow ) \
	((MetaClass*)getClass())->addProperty( new FixedArrayClassProperty( #propName , MetaClass::FIRST_VERSION + version, \
   (pointer_diff)(&( obj_null_pointer->propName ) - ((pointer_diff)NULL)) , new Card8ClassProperty("", version , ((pointer_diff)NULL)) \
	,count, sizeof(card8), entriesPerRow ));

#define ADD_BOOLEAN_FIXED_ARRAY_PROP( propName, version, count, entriesPerRow ) \
	((MetaClass*)getClass())->addProperty( new FixedArrayClassProperty( #propName , MetaClass::FIRST_VERSION + version, \
   (pointer_diff)(&( obj_null_pointer->propName ) - ((pointer_diff)NULL)) , new BooleanClassProperty("", version , ((pointer_diff)NULL)) \
	,count, sizeof(bool), entriesPerRow )); 


#define ADD_OBJECT_FIXED_ARRAY_PROP( propName, version, count, baseClass, is_owner ) \
	((MetaClass*)getClass())->addProperty( new FixedArrayClassProperty( #propName , MetaClass::FIRST_VERSION + version, \
   (pointer_diff)(&( obj_null_pointer->propName ) - ((pointer_diff)NULL)) , new ObjectClassProperty("", version , ((pointer_diff)NULL), \
	baseClass , is_owner ) ,count, sizeof(card32), 1 ));

#define ADD_VECTOR2F_PROP_UPDATE( propName, version, updateMethodPtr ) \
	((MetaClass*)getClass())->addProperty( new FixedArrayClassProperty( #propName , MetaClass::FIRST_VERSION + version, \
   (pointer_diff)(&( obj_null_pointer->propName ) - ((pointer_diff)NULL)) , new Float32ClassProperty("", version , ((pointer_diff)NULL), (Float32UpdateMethod)updateMethodPtr) \
	,2, sizeof(float32), 2 ));

#define ADD_VECTOR2I_PROP_UPDATE( propName, version, updateMethodPtr ) \
	((MetaClass*)getClass())->addProperty( new FixedArrayClassProperty( #propName , MetaClass::FIRST_VERSION + version, \
   (pointer_diff)(&( obj_null_pointer->propName ) - ((pointer_diff)NULL)) , new Int32ClassProperty("", version , ((pointer_diff)NULL), (Int32UpdateMethod)updateMethodPtr) \
	,2, sizeof(int32), 2 ));

...
#define ADD_VAR_ARRAY_PROP( myClassName, propName, version, elementProperty ) \
	((MetaClass*)getClass())->addProperty( new VariableArrayClassProperty( string(#propName) + "s" , MetaClass::FIRST_VERSION + version, \
	 elementProperty,\
	 (VariableArrayClassProperty::SetSizeMethod)& myClassName :: setNum##propName##s, \
	 (VariableArrayClassProperty::DeleteMethod)& myClassName :: delete##propName, \
	 (VariableArrayClassProperty::GetMethod) & myClassName :: get##propName, \
	 (VariableArrayClassProperty::GetNumMethod) & myClassName :: getNum##propName##s, \
	 (VariableArrayClassProperty::GetObjectNameMethod) & myClassName :: get##propName##Name ));

#define ADD_STRING_VAR_ARRAY_PROP( myClassName, propName, version ) \
	ADD_VAR_ARRAY_PROP( myClassName, propName, version, new StringClassProperty("element", MetaClass::FIRST_VERSION + version, 0))

#define ADD_INT32_VAR_ARRAY_PROP( myClassName, propName, version ) \
	ADD_VAR_ARRAY_PROP( myClassName, propName, version, new Int32ClassProperty("element", MetaClass::FIRST_VERSION + version, 0))
#define ADD_CARD32_VAR_ARRAY_PROP( myClassName, propName, version ) \
	ADD_VAR_ARRAY_PROP( myClassName, propName, version, new Card32ClassProperty("element", MetaClass::FIRST_VERSION + version, 0))
#define ADD_FLOAT32_VAR_ARRAY_PROP( myClassName, propName, version ) \
	ADD_VAR_ARRAY_PROP( myClassName, propName, version, new Float32ClassProperty("element", MetaClass::FIRST_VERSION + version, 0))
#define ADD_VECTOR3F_VAR_ARRAY_PROP( myClassName, propName, version ) \
	ADD_VAR_ARRAY_PROP( \
		myClassName, \
		propName, \
		version, \
...
#define IMPLEMENT_VAR_ARRAY_METHODS_STL( propName ) \
	...
	string get##propName##Name(mpcard index ) \
		{pAssert( index < propName.size()); UNUSED(index); return "Object";}

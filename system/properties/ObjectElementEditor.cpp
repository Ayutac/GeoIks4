...
ObjectElementEditor::ObjectElementEditor(QWidget * parent,Qt::WindowFlags f)
:ElementEditor(parent,f)
{
	...
	button_edit->setIcon(QIcon(":/images/ArrowDropDownSmall.png"));
	QPushButton * button_viewobj = new QPushButton( "", this );
	button_viewobj->setIcon(QIcon(":/images/DotDotDot.png"));

...
ObjectListElementEditor::ObjectListElementEditor(QWidget * parent,Qt::WindowFlags f)
:ElementEditor(parent,f)
{
   ...
   olee_setButtonIcon( m_ToTop, ":/images/up_top_arrow.png" );
   olee_setButtonIcon( m_ToBottom, ":/images/down_bottom_arrow.png" );
   olee_setButtonIcon( m_Up, ":/images/up_arrow.png" );
   olee_setButtonIcon( m_Down, ":/images/down_arrow.png" );

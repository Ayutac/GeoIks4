...
MaxPlatformIntClassProperty::MaxPlatformIntClassProperty(
   const string CName,
   const Version introducedInVersion,
...
//#else
//#ifdef XGRT_64BIT
//   minValue = -0x7FFFFFFFFFFFFFFFL; maxValue = 0x7FFFFFFFFFFFFFFFL;
//#else
//   this is bad (platform not defined)
//#endif
//#endif
}

MaxPlatformIntClassProperty::MaxPlatformIntClassProperty(
   const string CName, const Version introducedInVersion,
   pointer_diff offset, UpdateMethod updateAfterWrite)
...
MaxPlatformCardClassProperty::MaxPlatformCardClassProperty(
   const string CName, 
   const Version introducedInVersion,
   NumericalTypeGetPropertyMethod getMethod, 
   NumericalTypeSetPropertyMethod setMethod)
...
//#else
//#ifdef XGRT_64BIT
//   minValue = 0; maxValue = 0x7FFFFFFFFFFFFFFFL;
//#else
//   this is bad (platform not defined)
//#endif
//#endif
